 ...
 */
package com.euclid.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.euclid.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.euclid.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.euclid.releasevarient";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "euclid.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "euclid.updater.uri";
