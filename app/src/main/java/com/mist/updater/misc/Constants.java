...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.mist.base.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.mist.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.mist.buildtype";
    public static final String PROP_ZIP_TYPE = "ro.mist.edition";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "mist.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "mist.updater.uri";
